...
class Exercise(Base):
    ...
    publication_status = Column(String, nullable=False, server_default="legacy")
    content_version = Column(String, nullable=True)
    published_revision_id = Column(String, nullable=True)
    structured_content = Column(JSONB, nullable=True)
    movement_pattern = Column(String, nullable=True)
    resistance_modality = Column(String, nullable=True)
    difficulty = Column(String, nullable=True)
    laterality = Column(String, nullable=True)
    load_profile = Column(JSONB, nullable=True)
    tracking_mode = Column(String, nullable=True)
    generation_eligible = Column(Boolean, nullable=False, server_default=text("true"))
    published_media = Column(JSONB, nullable=True)
    legacy_snapshot = Column(JSONB, nullable=True)
